...
Config.ClothingRooms = {
    [1] = {requiredJob = "police", coords = vector3(462.98, -998.81, 30.69), cameraLocation = vector4(460.49, -998.81, 30.69, 265.64)},
    [2] = {requiredJob = "ambulance", coords = vector3(305.97, -597.9, 43.28), cameraLocation = vector4(305.63, -600.34, 43.28, 353.07)}, -- Right double door in Hospital Map that is on QBCore GitHub
    ...
    ["police"] = { -- Job
        ["male"] = { -- Gender
			[0] = { -- Grade Level
				...
				[5] = {
					outfitLabel = "Operacional Tático",
					outfitData = {
